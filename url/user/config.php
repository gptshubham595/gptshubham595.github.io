...
$username = "shubh40_shubhamggps"; 
$password = "Shivamclass12$#"; 
$host = "localhost"; 
$dbname = "shubh40_url"; 
...
define( 'YOURLS_SITE', 'http://shubhamggps.co/url' );
...
define( 'YOURLS_COOKIEKEY', 'shubhamguptaggpsrandomcookiekey' );

/** Username(s) and password(s) allowed to access the site. Passwords either in plain text or as encrypted hashes
 ** YOURLS will auto encrypt plain text passwords in this file
 ** Read http://yourls.org/userpassword for more information */
$yourls_user_passwords = array(
	'shubhamggps' => 'phpass:!2a!08!2r7Xy7agabRrC90.qfbIP.P.prWqx9O5urazJmEqFiQ2TM1HV6mqe' /* Password encrypted by YOURLS */ ,
